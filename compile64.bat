...
gfortran libmix.a -Jmodules -LC:\MinGW64\lib -static-libgcc -static-libgfortran -m64 -D _WIN32 -cpp -o mixreg
cd ..
move "mixreg\mixreg.exe" "Windows64 Binaries"
echo 'repeat_mixreg'
cd repeat_mixreg
gfortran -c -o repeat_mixreg.o -g -static -m64 -D _WIN32 -cpp repeat_mixreg.f90
gfortran repeat_mixreg.o  -LC:\MinGW64\lib  -static-libgcc -static-libgfortran  -m64 -D _WIN32 -cpp -o repeat_mixreg
cd ..
...
gfortran mix_random.o  -LC:\MinGW64\lib  -static-libgcc -static-libgfortran  -m64 -D _WIN32 -cpp -o mix_random
cd ..
...
gfortran libmix.a -LC:\MinGW64\lib -static-libgcc -static-libgfortran -m64 -D _WIN32 -cpp -o mixregls_random_mixreg
cd ..
...
gfortran libmix.a -LC:\MinGW64\lib -static-libgcc -static-libgfortran -m64 -D _WIN32 -cpp -o mixregls_random_mixor
cd..
...
gfortran repeat_mixor.o  -LC:\MinGW64\lib  -static-libgcc -static-libgfortran  -m64 -D _WIN32 -cpp -o repeat_mixor
cd ..
...
gfortran libmix.a -LC:\MinGW64\lib -static-libgcc -static-libgfortran -m64 -D _WIN32 -cpp -o mixregmls_random_mixreg
cd ..
...
gfortran libmix.a -LC:\MinGW64\lib -static-libgcc -static-libgfortran -m64 -D _WIN32 -cpp -o mixregmls_random_mixor
cd ..
...
gfortran libmix.a -Jmodules -LC:\MinGW64\lib -static-libgcc -static-libgfortran -m64 -D _WIN32 -cpp -o mixor
cd ..
